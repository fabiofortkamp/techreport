...
\chapter{Personalizações feitas}
\label{sec:pers-feit}
...
Veja o arquivo \verb=techreport-article.pdf=, que acompanha a classe, para ver como ficaria um documento produzido assim.
