...
O título das listas iniciais (como sumário e lista de figuras também é alterado) e das referências ribliográficas também é alterado, e é usado o ``\&'' nas citações com mais de um autores (como em \citeonline{abntex2cite}). 
